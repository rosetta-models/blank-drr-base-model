...
public class BANKABCCleanAndPrep {

    private static final Logger LOGGER = LoggerFactory.getLogger(BANKABCCleanAndPrep.class);
    ...
    static void emptySampleAndTestPackFolders(Path... foldersToClean) {
       ...
       Arrays.stream(foldersToClean)
                ...
                .forEach(BANKABCCleanAndPrep::delete);
    }
