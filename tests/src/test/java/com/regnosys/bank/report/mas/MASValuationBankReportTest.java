...
public class MASValuationBankReportTest {
    ...
    private static Stream<Arguments> inputFiles() {
        return testExtension.getArguments().filter(testPack -> testPack.get()[1].toString().startsWith("test-pack-report-mas-valuation-mas-valuation"));
    }
}
