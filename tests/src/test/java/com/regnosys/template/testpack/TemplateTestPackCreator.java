...
public class TemplateTestPackCreator {

    private static final Logger LOGGER = LoggerFactory.getLogger(TemplateTestPackCreator.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            LOGGER.error("Error executing {}.main()", TemplateTestPackCreator.class.getName(), e);
            System.exit(1);
        }
    }
