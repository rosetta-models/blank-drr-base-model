package com.regnosys.placeholder.projection.iso20022.asic;
...
//                .filter(testPack -> testPack.get()[1].toString().startsWith("test-pack-projection-asic-trade-report-to-iso20022-trade-bank"));
    }
}
