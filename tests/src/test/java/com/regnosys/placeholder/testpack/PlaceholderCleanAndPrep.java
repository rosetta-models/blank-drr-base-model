...
public class PlaceholderCleanAndPrep {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlaceholderCleanAndPrep.class);
    ...
    static void emptySampleAndTestPackFolders(Path... foldersToClean) {
       ...
       Arrays.stream(foldersToClean)
                ...
                .forEach(PlaceholderCleanAndPrep::delete);
    }
