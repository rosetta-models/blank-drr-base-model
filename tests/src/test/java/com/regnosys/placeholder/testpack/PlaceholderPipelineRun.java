...
public class PlaceholderPipelineRun {
    private static final Logger LOGGER = LoggerFactory.getLogger(PlaceholderPipelineRun.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PlaceholderCleanAndPrep.emptySampleAndTestPackFolders(enrichPath, reportPath, projectionPath);
            ...
            PlaceholderReportableEventFileDropProcessor placeholderReportableEventFileDropProcessor = injector.getInstance(PlaceholderReportableEventFileDropProcessor.class);
            placeholderReportableEventFileDropProcessor.runFileProcessor(TRADE_GROUP, jpmFileDrop, enrichInputPath);
            PlaceholderValuationFileDropProcessor placeholderValuationFileDropProcessor = injector.getInstance(PlaceholderValuationFileDropProcessor.class);
            placeholderValuationFileDropProcessor.runFileProcessor(ASIC_VALUATION_GROUP, jpmFileDrop, enrichInputPath);
            placeholderValuationFileDropProcessor.runFileProcessor(MAS_VALUATION_GROUP, jpmFileDrop, enrichInputPath);
            ...
            LOGGER.error("Error executing {}.main()", PlaceholderPipelineRun.class.getName(), e);
            System.exit(1);
        }
    }
